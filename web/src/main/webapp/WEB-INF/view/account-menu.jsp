...
<div class="dropdown">
	...
	<button class="dropdown-toggle navbar navbar-default borderless"
		...
		<span class="withPadding"><img id="avatar"
			class="img-circle sized" alt="User Pic"
			src="${basedir}/user/profile/avatar"></span> <span id="menuUsername"
			class="nav navbar-nav withPadding"></span> <span class="caret"></span>
	</button>
	<ul class="dropdown-menu dropdown-menu-right" role="menu"
		...
		<li role="presentation"><a role="menuitem" tabindex="-1"
			href="${basedir}/user/attempts">View my attempts</a></li>
		<li role="presentation"><a role="menuitem" tabindex="-1"
